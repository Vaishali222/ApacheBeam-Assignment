...
class TotalSales {
        ...
        pipeline.apply("Read-Lines", TextIO.read()
                ...
                .apply("Map", MapElements
                        ...
                        .via((String line) -> {
                            ...
                            return KV.of(line.split("/")[1], Double.parseDouble(tokens[2]));
                        }))
                .apply("Combine", Sum.doublesPerKey())
    ...
    public interface PriceProcessingOptions extends PipelineOptions {
        ...
        @Default.String("src/main/resources/SalesJan2009 - SalesJan2009.csv")
        String getInputFile();

        void setInputFile(String value);

        @Description("Path of the file to write")
        @Default.String("src/main/resources/Output/TotalSale")
